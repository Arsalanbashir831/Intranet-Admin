...
export function MfaDialog({ open, onOpenChange, isEnabled }: MfaDialogProps) {
  const [view, setView] = React.useState<MfaViewState>("initial");
            ...
            {isEnabled ? (
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-500">
                  To disable 2FA, you will need to enter a code from your
                  authenticator app.
                </p>
              ...
              <div className="space-y-4">
                <p className="text-sm text-gray-500">
                  When enabled, you will need to use an authenticator app (like
                  Google Authenticator) to generate a code when logging in.
                </p>
                <div className="flex justify-end">
          ...
          <form onSubmit={handleConfirmEnroll} className="space-y-6 py-4">
            <div className="flex flex-col items-center space-y-4">
              <div className="p-4 bg-white border rounded-lg shadow-sm">
                {otpAuthUri && <QRCodeSVG value={otpAuthUri} size={160} />}
              </div>
