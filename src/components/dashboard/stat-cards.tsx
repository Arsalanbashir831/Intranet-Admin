...
import { StatCardItem } from "@/types/dashboard";
import { formatStatValue } from "@/handlers/dashboard-handlers";
        ...
        <Card
          ...
          <div className="mt-4">
            ...
            <div className="mt-1 text-2xl font-bold text-secondary">
              {formatStatValue(item.value, item.padTo)}
            </div>
          </div>
        </Card>
      ))}
    ...
    () => [
      {
        ...
        value: stats.data?.totals.branches || 0,
        iconPath: "/icons/building-apartment.svg",
        padTo: 0,
      },
      {
        id: "departments",
        label: "Departments",
        value: stats.data?.totals.departments || 0,
        iconPath: "/icons/user-hierarchy.svg",
        padTo: 0,
      },
      {
        id: "policies",
        label: "Policies",
        value: knowledgeBaseStats.data?.totals.type_policies || 0,
        iconPath: "/icons/page-folded.svg",
        padTo: 0,
      },
      {
        id: "people",
        label: "People",
        value: stats.data?.totals.employees || 0,
        iconPath: "/icons/users-filled.svg",
        padTo: 0,
      },
    ],
