...
export const TagsValue = ({
  ...
  ...props
}: TagsValueProps & { onRemove?: () => void, icon?: ReactNode, iconContainerClassName?: string }) => {
  ...
  return (
    <Badge className={cn("flex items-center gap-2", className)} {...props}>
      ...
      {onRemove && (
        ...
        <div
          className={cn("size-auto cursor-pointer hover:text-muted-foreground", iconContainerClassName)}
