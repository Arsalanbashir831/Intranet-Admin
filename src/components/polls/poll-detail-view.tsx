  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="shadow-none border-[#D0D0D0]">
        <CardHeader>
          <div className="flex items-start justify-between">
            <div>
              <h3 className="font-bold text-2xl mb-2">Question</h3>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="mt-1 text-sm font-medium text-secondary">
                    {format(new Date(poll.created_at), "MMM dd, yyyy")}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xl border-2 border-secondary bg-[#FFF4F8] px-5 py-4 shadow-none">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="mt-1 text-sm font-medium text-secondary capitalize">
                    {poll.poll_type}
                  </div>
                </div>
              </div>
                  ...
                  <BarChart
                    ...
                    <Tooltip
                      formatter={(value: number, name: string) => [
                        `${value} votes (${chartData
                          .find((d) => d.votes === value)
                                  ...
                                  <div
                                    ...
                                    <div className="flex-1 min-w-0">
                                      ...
                                      {voter.branch_department && (
                                        <p className="text-xs text-muted-foreground truncate">
                                          {voter.branch_department.branch.name}{" "}
                                          -{" "}
                                          {
                                            voter.branch_department.department
                                              .name
                                          }
                                        </p>
                                      )}
      ...
      <Card className="shadow-none border-[#D0D0D0]">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3">
            {poll.permitted_branches_details &&
              poll.permitted_branches_details.length > 0 && (
                <div>
                  <h4 className="font-medium text-sm text-muted-foreground mb-2">
                    Branches
                  </h4>
                  <div className="flex flex-wrap gap-2">
                    {poll.permitted_branches_details.map(
                      (branch: BranchDetail) => (
            ...
            {poll.permitted_departments_details &&
              poll.permitted_departments_details.length > 0 && (
                <div>
                  <h4 className="font-medium text-sm text-muted-foreground mb-2">
                    Departments
                  </h4>
                  <div className="flex flex-wrap gap-2">
                    {poll.permitted_departments_details.map(
            ...
            {poll.permitted_branch_departments_details &&
              poll.permitted_branch_departments_details.length > 0 && (
                <div>
                  <h4 className="font-medium text-sm text-muted-foreground mb-2">
                    Branch Departments
                  </h4>
                  <div className="flex flex-wrap gap-2">
                    {poll.permitted_branch_departments_details.map(
                      (bd: BranchDepartmentDetail) => (
            ...
            {poll.permitted_employees_details &&
              poll.permitted_employees_details.length > 0 && (
                <div>
                  <h4 className="font-medium text-sm text-muted-foreground mb-2">
                    Employees
                  </h4>
                  <div className="flex flex-wrap gap-2">
                    {poll.permitted_employees_details.map(
                      (emp: EmployeeDetail) => (
            ...
            {(!poll.permitted_branches_details ||
              ...
              (!poll.permitted_employees_details ||
                ...
                <div className="text-center py-4 text-muted-foreground">
                  <p className="text-sm">
                    This poll has public access (no specific permissions set)
                  </p>
                </div>
              )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm">
                  {format(expiresAt, "MMM dd, yyyy 'at' h:mm a")}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-medium text-sm text-muted-foreground">
                ...
                <span className="font-semibold text-primary">
                  {poll.total_votes > 0 && poll.options?.length
                    ? ((poll.total_votes / poll.options.length) * 100).toFixed(
                        1
                      )
                    : 0}
                  %
        ...
        <Card className="shadow-none border-[#D0D0D0]">
          ...
          <CardContent>
            ...
            <p className="font-semibold">
              {
                poll.options?.find((opt) => opt.id === poll.user_vote)
                  ?.option_text
              }
            </p>
          </CardContent>
