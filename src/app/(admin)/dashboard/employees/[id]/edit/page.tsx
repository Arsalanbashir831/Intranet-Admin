...
import type { OrgChartInitialValues } from "@/types/org-chart";
...
export default function EditOrgChartPage() {
  ...
  const branchDepartmentIds = React.useMemo(() => {
    ...
    const branchDeptIds = (
      apiEmployee as typeof apiEmployee & { branch_department_ids?: number[] }
    ...
    const branchDepartments = (
      apiEmployee as typeof apiEmployee & {
        branch_departments?: Array<{ id: number }>;
      }
    ).branch_departments;
    ...
    const singleBranchDept = (
      apiEmployee as typeof apiEmployee & { branch_department?: number }
    ).branch_department;
    if (singleBranchDept) {
  ...
  const roleId = React.useMemo(() => {
    ...
    const roleIdValue = (
      apiEmployee as typeof apiEmployee & { role_id?: number }
    ).role_id;
